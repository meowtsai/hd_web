    ...
    afterLoad: function(origin, destination, direction) {
      ...
      if (destination.index == 1) {
        document
          ...
          .querySelector(".ani1").style.opacity = 1;
        document
          .querySelector("#section1")
          .querySelector(".ani2").style.opacity = 1;
        document
          .querySelector("#section1")
          .querySelector(".ani3").style.opacity = 1;
        document
          .querySelector("#section1")
          .querySelector(".ani4").style.opacity = 1;
        document
          .querySelector("#section1")
          .querySelector(".ani5").style.opacity = 1;
      }
      ...
      //back to original state
        ...
        document
          .querySelector("#section1")
          .querySelector(".ani1").style.opacity = 0;
        document
          .querySelector("#section1")
          .querySelector(".ani2").style.opacity = 0;
        document
          .querySelector("#section1")
          .querySelector(".ani3").style.opacity = 0;
        document
          .querySelector("#section1")
          .querySelector(".ani4").style.opacity = 0;
        document
          .querySelector("#section1")
          .querySelector(".ani5").style.opacity = 0;
      }
        ...
        document.getElementById("pre_form").innerHTML =
          ...
          (response.registered
            ? "<br />在<font color='red'>" +
              ...
              "</font>"
            : "") +
          "已經收入我們的拓荒者登記簿，<br />請耐心等待我們完成基礎建設。 <br />" +
          " 期待與您共同開創海島新紀元！ <br />" +
