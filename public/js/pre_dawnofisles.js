...
$(".gugusay").fadeIn();	
	...
	function eyes_loop(){
		for(var i=0;i<100;i++){
		$(".gugueye").show(0).delay(Math.random()*500).hide(0).delay(Math.random()*5000);}	
	...
	//section2 swiper 
    var news_menu_text= ['不僅僅是島嶼建造和MMO冒險 《海島紀元》iOS版本上線', '聯動熊本熊！島嶼冒險遊戲《海島紀元》將於5月30日清新首發', '超不正經の島嶼冒險遊戲《海島紀元》即將推出'];
